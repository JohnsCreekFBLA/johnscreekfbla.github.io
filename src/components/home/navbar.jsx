      ...
      >
        ...
        <ul className={`navbar-links${open ? ' open' : ''}`}>
            ...
            <li className={`dropdown${activeDropdown === 'resources' ? ' active' : ''}`}>
                ...
                <div className="dropdown-content">
                    <a href="https://github.com/JohnsCreekFBLA/johnscreekfbla.github.io/blob/b8d31c9534de3bb71289b838a7bf4c1c77e67622/public/2526-Competitive-Event-Guideline.pdf" onClick={handleLinkClick}>25-26 Competitive Event Guideline</a>
